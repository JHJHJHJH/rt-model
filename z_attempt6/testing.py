...
X_test = df[['hour_of_day', 'is_weekend', 'temperature', 'humidity', 'season_Fall', 'season_Spring', 'season_Summer', 'season_Winter']]
loaded_model = joblib.load('rt_model_6.joblib')
...
df_res.to_csv('resources/6_predictions.csv',index=False)
