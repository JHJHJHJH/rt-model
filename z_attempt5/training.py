...
try:
    df = pd.read_csv('resources/5_Building_A.csv')
...
features = ['hour_of_day', 'day_of_week', 'month', 'is_weekend', 'day_of_month','temperature', 'humidity']
...
model_filename = 'rt_model_5.joblib'
